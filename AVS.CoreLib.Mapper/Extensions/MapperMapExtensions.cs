...
namespace AVS.CoreLib.Mapper.Extensions
{
    public static class MapperMapExtensions
    {
        ...
        /// <code>
        /// var models = mapper.MapAll&lt;Source,Model&gt;(items);
        /// </code>
        /// </summary>
        /// <typeparam name="TSource">source type</typeparam>
        /// <typeparam name="TDestination">destination type</typeparam>
        public static IEnumerable<TDestination> MapAll<TSource, TDestination>(this IMapper mapper, IEnumerable<TSource> source, Action<TDestination>? action = null)
        {
        ...
        /// </summary>
        public static TDestination Map<TSource, TDestination>(this IMapper mapper, TSource source, Action<TDestination> modify)
        {
